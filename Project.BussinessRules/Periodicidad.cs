...
namespace Project.BussinessRules
{
    public class Periodicidad : Planilla
    {
        ...
        **/
        ...
        public Periodicidad(string fecha, int cod, int codser, int codtec, string codarea, string oti, int consumo, string tperiodicidad, string estado, string observaciones, string nivel, string tiempo,string noconformidad)
            : base(cod)
        {
        ...
        public Periodicidad(string fecha, int cod, string tiempo, string oti)
            : base(cod)
        {
            this.Fecha = fecha;
        ...
        public Periodicidad(string fecha, int cod, int codser, int codtec, string codarea)
            : base(cod)
        {
        ...
        public Periodicidad(string noconformidad,string oti,int cod)
            : base(cod)
        {
            this.NoConformidad = noconformidad;
            this.Cod = cod;        
    ...
    public Periodicidad(int codi, string fecha, int codpla,int codser,int codtec)
        ...
        public Periodicidad(int cod, int codser, int codtec)
            : base(cod)
        {
