...
namespace Project.BussinessRules
{
    public class LugarTratamiento : cliente
    {
        ...
        public LugarTratamiento(string nombre, string rut, string clasificacion, string ltratamiento, string telefono, string email, string tipo, string estado)
            : base(nombre, rut, clasificacion, ltratamiento)
        {
            this.CODNT = codnt;
            this.COD = cod;
        ...
        public LugarTratamiento(int cod, string rut, string ltratamiento, string ruta, string tipo,string estado)
        ...
        //cambiar de razon social
        public LugarTratamiento(string ltratamiento, string ruta, int cod, string rut, int codnt)
            : base(ltratamiento, ruta, cod, rut, codnt)
        {
            this.CODNT = codnt;
            this.NombreTrata = ltratamiento;
            this.Ruta = ruta;
