   ...
   public class Inventariado
    {
     ...
     DateTime fecha;
       ...
       */
       ...
       public Inventariado(string tec,string ruta,string tipo ,string ser, string cli, string rut, string descripcion, string lugartratamiento, string area, DateTime fecha, string cod,string descripcionparticular)
       {
           this.Tec = tec;
           this.Ser = ser;
           this.Cli = cli;
