   ...
   public class InventariadoR
    {
       ...
       */
       ...
       public InventariadoR(string tecR,string ruta,string tipor, string serR, string cliR, string rutR, string consumoR, string descripcionR, string lugartratamientoR, string areaR, DateTime fechaR, string codR, string otiR, string estadoR)
       {
