   ...
   public class Otros
    {
        ...
        Bitmap bmp;
        Bitmap newbmp;
        Image newImage = Image.FromFile(@"\\STORAGE\\Public\\Esam compartido\\Informática\\imagenes\\Otros.Png");
        ...
        string codplano;
        string tipo;
        public Otros(int cx, int cy, int dx, int dy, int numero, string codplano, string tipo) 
        {
            this.Cx = cx;
            this.Cy = cy;
            this.Dx = dx;
        ...
        public void Draw(Graphics grfx)
        {
            ...
            newImage = Image.FromFile(@"\\STORAGE\\Public\\Esam compartido\\Informática\\imagenes\\Otros.Png");      
        ...
        public void listobmp()
        {
            ...
            Imagen = newImage;
            bmp = new Bitmap("C:\\Users\\Urukazo\\Desktop\\respaldo bueno\\Otros.png");
