...
namespace Project.Esampm
{
    class Palabras
    {
        ...
        public void Draw(Graphics grfx)
        {
                ...
                Font myFont = new Font("Arial", F);
                Cx = Point1.X;
                Cy = Point1.Y;
                // Draw image to screen.
                // g.DrawImage(newImage, ulCorner);
                grfx.DrawString(TEX, myFont, Brushes.Black, Point1);
        ...
        public void DrawVertical(Graphics grfx)
        {
            ...
            grfx.DrawString(TEX, myFont, Brushes.Black, Point1, stringFormat);
            //  grfx.Dispose();
            //  pen.Dispose();
        }
    }
