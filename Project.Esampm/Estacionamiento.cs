...
namespace Project.Esampm
{
    class Estacionamiento
    {
        ...
        public void Draw(Graphics grfx)
        {
            ...
            Image newImage = Image.FromFile(@"\\STORAGE\\Public\\Esam compartido\\Informática\\imagenes\\Estacionamiento.jpg");
            ...
            else
            {
                if (Dx < Dy)
                {
                    newImage = Image.FromFile(@"\\STORAGE\\Public\\Esam compartido\\Informática\\imagenes\\EstacionamientoH.jpg");
                    grfx.DrawImage(newImage, Cx, Cy, Dx, Dy);
                }
            }
        }
