...
namespace Project.Esampm
{
    class Anclado
    {
        ...
        public Anclado()
        { }
        public Anclado(int cx, int cy, int dx, int dy, int numero, string codplano, string tipo) 
        {
            this.Cx = cx;
            this.Cy = cy;
            this.Dx = dx;
        ...
        public void Draw(Graphics grfx)
        {
            ...
            Image newImage = Image.FromFile(@"\\STORAGE\\Public\\Esam compartido\\Informática\\imagenes\\Anclado.jpg");
