...
{
    public partial class EditorPlanos : Form
    {
      public  Boolean vertical = false;
        ...
        private NumeroPlano m_NumeroPlano;
        Boolean activarNumeroPlano;
        private List<Actualizadopor> m_lstOfNumeroActualizado = new List<Actualizadopor>();
        private Actualizadopor m_Actualizado;
        Boolean activarActualizado;
        int conttri = 0;
        int contcri = 0;
        int controjo = 0;
        int concua = 0;
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            if ((((m_tri) != null)))
            {
                ...
                //m_tri.Draw(g.RotateTransform(90));
                pictureBox1.Invalidate();
                //   pictureBox1.Update();
                //  foreach (Triangulo1 item in m_lstOfTri) 
                //    {
                //       if (m_tri.Cx == item.Cx && m_tri.Cy == item.Cy) 
                //       {
                //           clic = true;
                //        }else{
                //            clic = false;
            ...
            m_lstOfNumeroPlano.ForEach((NumeroPlano item) => { item.Draw(g); });
            if ((((m_NumeroPlano) != null)) && comboBox1.Text != textBox5.Text)
            {
                //  pointFillpalabra.Add(m_fillpalabra);
                m_NumeroPlano.Draw(g);


                // pointFillpalabra.Clear();
            }
            m_lstOfNumeroActualizado.ForEach((Actualizadopor item) => { item.Draw(g); });
            if ((((m_Actualizado) != null)) && comboBox1.Text != comboBox4.Text)
            {
                //  pointFillpalabra.Add(m_fillpalabra);
                m_Actualizado.Draw(g);
      ...
      //      g = CreateGraphics();
        ...
        private void EditorPlanos_Load(object sender, EventArgs e)
        {
            m_tri = new Triangulo1();
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            gc.DrawRectangle(blackPen, 0, 0, wx, wy);
          ...
          //  Graphics gc;
           // gc = pictureBox1.CreateGraphics();
           // Pen blackPen = new Pen(Color.Black, 10);
            //gc.DrawRectangle(blackPen, 0, 0, 1040, 652);
            ...
            using (FileStream stream = new FileStream(folderPath + textBox5.Text + "-" + textBox2.Text +".pdf", FileMode.Create))
            {
              ...
              //      iTextSharp.text.Image imagen1 = iTextSharp.text.Image.GetInstance("C:\\Users\\Urukazo\\Desktop\\respaldo bueno\\esam.jpg");
                ...
                //  iTextSharp.text.Image imagen1 = iTextSharp.text.Image.GetInstance(@"\\STORAGE\\Public\\Esam compartido\\Informática\\esam.jpg");
              //  iTextSharp.text.Image imagen2 = iTextSharp.text.Image.GetInstance("C:\\Users\\Urukazo\\Desktop\\respaldo bueno\\"+s.FileName+".png");
                //    iTextSharp.text.Image imagen1 = iTextSharp.text.Image.GetInstance("C:\\Users\\natal\\Desktop\\Ejecutableroot\\esam.jpg");    
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            der = true;
            m_tri.Imagen.RotateFlip(RotateFlipType.Rotate270FlipNone);
            m_lstOfTri.Add(m_tri);
            pictureBox1.Invalidate();
            pictureBox1.Refresh();
        ...
        {
            activarNumeroPlano = true;
            if (activarNumeroPlano == true)
            {
              
                    pictureBox1.Capture = true;
                    m_NumeroPlano = new NumeroPlano();
                    m_NumeroPlano.Point1 = new Point(700,0);
                    //  m_fillpalabra.PointFF = e.Location;
                    m_NumeroPlano.TEX = textBox5.Text;
                    m_NumeroPlano.F = Convert.ToInt32(comboBox1.Text);
                    texto.Add(m_NumeroPlano.TEX);
        ...
        {
          //  if (activarPalabras == true&& pointFillpalabra.Count>=1)
          //  {
          ...
          //  }
            ...
            {
                if (activarLine == true && m_lstOfLine.Count >= 1)
                {
            ...
            {
                if (activarCircle == true && m_lstOfCircle.Count >= 1)
                {
            ...
            {
                if (activarRectangulo == true && m_lstOfRectangulo.Count >= 1)
                {
            ...
            {
                if (activarBasura == true && m_lstOfBasura.Count >= 1)
                {
            ...
            {
                if (activarArbol == true && m_lstOfArbol.Count >= 1)
                {
            ...
            {
                if (activarCacha == true && m_lstOfCancha.Count >= 1)
                {
            ...
            {
                if (activarPalabrasVertical == true && pointFillpalabraVertical.Count >= 1)
                {
            ...
            {
                if (activarEsta == true && m_lstOfEsta.Count >= 1)
                {
        ...
        {
              activarActualizado = true;
            if (activarActualizado == true)
            {
              
                    pictureBox1.Capture = true;
                    m_Actualizado = new Actualizadopor();
                    m_Actualizado.Point1 = new Point(0,0);
                    //  m_fillpalabra.PointFF = e.Location;
                    m_Actualizado.TEX = comboBox4.Text;
                    m_Actualizado.F = Convert.ToInt32(comboBox1.Text);
                    texto.Add(m_Actualizado.TEX);
        ...
        {
            pictureBox1.Width = wx;
            pictureBox1.Height = wy;
            this.pictureBox1.Size = new System.Drawing.Size(wx, wy);
