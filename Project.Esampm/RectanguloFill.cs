...
namespace Project.Esampm
{
    class RectanguloFill
    {
        ...
        { }
        public RectanguloFill(int cx, int cy, int dx, int dy, int numero, string codplano, string tipo) 
        {
            this.Cx = cx;
            this.Cy = cy;
            this.Dx = dx;
        ...
        public void Draw(Graphics grfx)
        {
          ...
          //  Rectangle rect = new Rectangle(0, 100, 200, 200);
            grfx.FillRectangle(new SolidBrush(Color.Black), Cx, Cy, Dx, Dy);
