  ...
  public  class fillCirculo
    {
        ...
        public fillCirculo()
        { }
        public fillCirculo(int cx, int cy, int dx, int dy, int numero, string codplano, string tipo) 
        {
            this.Cx = cx;
            this.Cy = cy;
            this.Dx = dx;
        ...
        public void Draw(Graphics grfx)
        {
            ...
            grfx.FillEllipse(new SolidBrush(Color.Black), Cx, Cy, Dx, Dy);
