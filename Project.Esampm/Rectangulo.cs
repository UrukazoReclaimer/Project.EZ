...
namespace Project.Esampm
{
    public class Rectangulo
    {
        ...
        public Rectangulo() { }
        public Rectangulo(Point pt1, Point pt2, Point pt3, Point pt4)
        {
            gp = new GraphicsPath();
        ...
        public void DrawRectangulo(Graphics g, Point puntoInicial, Point puntoFinal)
        {
            //Dibujando empezando de arriba hasta llegar punto inicial por la derecha
            Pen pen = new Pen(Color.Black, 2);
            g.SmoothingMode = SmoothingMode.AntiAlias;
           //dibujar rectangulooooo
