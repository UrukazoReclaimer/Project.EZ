...
namespace Project.Esampm
{
    class Gota
    {
        ...
        public Gota()
        { }
        public Gota(int cx, int cy, int dx, int dy, int numero, string codplanom, string tipo) 
        {
            this.Cx = cx;
            this.Cy = cy;
            this.Dx = dx;
        ...
        public void Draw(Graphics grfx)
        {
            ...
            Image newImage = Image.FromFile(@"\\STORAGE\\Public\\Esam compartido\\Informática\\imagenes\\gota.jpg");
