...
namespace Project.Esampm
{
    class Zanja
    {
        ...
        public void Draw(Graphics grfx)
        {
            ...
            Image newImage = Image.FromFile(@"\\STORAGE\\Public\\Esam compartido\\Informática\\imagenes\\Zanga.jpg");
            ...
            else
            {
                if (Dx > Dy)
                {
                    newImage = Image.FromFile(@"\\STORAGE\\Public\\Esam compartido\\Informática\\imagenes\\ZangaH.jpg");
                    grfx.DrawImage(newImage, Cx, Cy, Dx, Dy);
                }
            }
        }
