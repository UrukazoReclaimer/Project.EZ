...
namespace Project.Esampm
{
    class Zona
    {
        ...
        public void Draw(Graphics grfx)
        {
            ...
            Image newImage = Image.FromFile(@"\\STORAGE\\Public\\Esam compartido\\Informática\\imagenes\\Zona.jpg");
            ...
            else
            {
                if (Dx < Dy)
                {
                    newImage = Image.FromFile(@"\\STORAGE\\Public\\Esam compartido\\Informática\\imagenes\\ZonaH.jpg");
                    grfx.DrawImage(newImage, Cx, Cy, Dx, Dy);
                }
            }
